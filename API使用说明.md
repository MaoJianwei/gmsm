...
```bash
go get -u github.com/MaoJianwei/gmsm
```
...
- go package： `github.com/MaoJianwei/gmsm/sm2`
...
- g package：`github.com/MaoJianwei/gmsm/sm3`
...
- go package：`github.com/MaoJianwei/gmsm/sm4`

### 代码示例

```Go
    import  "crypto/cipher"
    import  "github.com/MaoJianwei/gmsm/sm4"
    import "fmt"
...
### 具体功能测试代码参考
```Go
github.com/MaoJianwei/gmsm/sm2/sm2_test.go  //sm2算法
github.com/MaoJianwei/gmsm/sm3/sm3_test.go  //sm3算法
github.com/MaoJianwei/gmsm/sm4/sm4_test.go  //sm4算法
github.com/MaoJianwei/gmsm/x509/x509_test.go //x509国密证书
github.com/MaoJianwei/gmsm/gmtls/gmcredentials/credentials_test.go  //国密tls
github.com/MaoJianwei/gmsm/gmtls/gmcredentials/websvr/websvr.go     //国密tls与非国密TLS自适应
```
